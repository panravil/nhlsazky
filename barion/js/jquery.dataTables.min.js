...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:25,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"První",sLast:"Poslední",sNext:"Další",sPrevious:"Předchozí"},sEmptyTable:"Nejsou dostupná žádná data",sInfo:"Zobrazeno _START_ až _END_ of _TOTAL_ záznamů",sInfoEmpty:"Zobrazeno 0 záznamů",
sInfoFiltered:"(vybráno z _MAX_ celkových záznamů)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Zobrazit _MENU_ záznamů",sLoadingRecords:"Načítám...",sProcessing:"Pracuji...",sSearch:"Vyhledávání:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Žádný výsledek nebyl nalezen"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
