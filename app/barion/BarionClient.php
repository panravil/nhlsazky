...
namespace App\barion;
use App\barion\common\BarionEnvironment;
use App\barion\common\QRCodeSize;
use App\barion\models\ApiErrorModel;
use App\barion\models\BaseResponseModel;
use App\barion\models\payment\CancelAuthorizationRequestModel;
use App\barion\models\payment\CancelAuthorizationResponseModel;
use App\barion\models\payment\CaptureRequestModel;
use App\barion\models\payment\CaptureResponseModel;
use App\barion\models\payment\FinishReservationRequestModel;
use App\barion\models\payment\FinishReservationResponseModel;
use App\barion\models\payment\PaymentQRRequestModel;
use App\barion\models\payment\PaymentStateResponseModel;
use App\barion\models\payment\PreparePaymentRequestModel;
use App\barion\models\payment\PreparePaymentResponseModel;
use App\barion\models\refund\RefundRequestModel;
use App\barion\models\refund\RefundResponseModel;
...
class BarionClient
{
    ...
    {
        $model = new PreparePaymentRequestModel($paymentId);
        $model->POSKey = $this->POSKey;
