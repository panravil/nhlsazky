        <div class="col-6 col-sm-4 col-md-3 col-xl-2 zapasek">
            <div class="hlavni_zapasy bg-zapas-{{ $match->timelabel }}">
                ...
                <div class="row zapas-teams">
                    <div class="col-6 col-md-4 col-sm-4 text-center">
                        ...
                        <b class="d-block d-sm-none-inline">{{ $match->score_host }}</b>
                @endif
                    </div>
                ...
                @endif
                    <div class="col-6 col-md-4 col-sm-4 text-center">
                        ...
                        <b class="d-block d-sm-none-inline">{{ $match->score_guest }}</b>
                @endif
                    </div>
                </div>
            </div>
