  @php
  $tickets = App\Ticket::where('status', '=', '1')->count() * 100;
   $good = \App\Ticket::where('status', '=', '1')->count() + \App\Ticket::where('status', '=', '2')->count();
  if($good == 0) {
    $acc = 0;
  } else {
              ...
              <div class="card border-left-{{ $color }} shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-{{$color}} text-uppercase mb-1">Přesnost (CELKEM)</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
